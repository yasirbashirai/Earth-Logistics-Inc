...
// All images verified — real US freight truck / warehouse photography
export const services: Service[] = [
  ...
  },
  {
    ...
    short: "39' end dump trailers for aggregates, sand & dry bulk.",
    blurb:
      "39' end dump and side dump trailers for aggregates, demolition debris, sand, crushed stone and dry bulk commodities.",
    long: "Earth Logistics' bulk division operates an active network of 39' end dump and side dump trailers covering aggregates, sand, gravel, soil and demolition debris. We dispatch dry bulk capacity for mine haul, demolition cleanup, recycling and import/export bulk staging — with the responsiveness construction and industrial jobs demand.",
    image: "/images/services/end-dump-39ft.jpg",
    category: "Bulk",
    capabilities: [
      "39' end dump trailers with trailer",
      "Side dump trailers",
    ...
    faqs: [
      {
        q: "What size end dump trailers do you run?",
        a: "Our network operates 39' end dump trailers and side dump trailers — the standard heavy-bulk configuration for aggregates and dry materials.",
      },
      {
    ...
    keywords: ["end dump trucking", "39 foot end dump", "aggregate hauling", "dry bulk trucking"],
  },
  {
    ...
    image: "/images/services/pneumatic-tanker.jpg",
    category: "Bulk",
    capabilities: [
