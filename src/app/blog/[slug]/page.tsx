    ...
    <>
      ...
      <div className="bg-slate-50 border-b border-slate-200">
        <div className="container-page py-3 text-xs text-slate-500 flex items-center gap-1">
          ...
          <Link href="/blog" className="hover:text-[--color-brand-700]">Blog</Link>
          <ChevronRight className="w-3 h-3" />
        ...
        <div className="container-page grid grid-cols-1 lg:grid-cols-12 gap-10">
          <article className="lg:col-span-8 prose-content">
            <div className="flex flex-wrap items-center gap-5 text-sm text-slate-500">
              <span className="flex items-center gap-1.5"><User className="w-4 h-4 text-[--color-brand-600]"/> {post.author}</span>
              <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4 text-[--color-brand-600]"/> {post.date}</span>
              <span className="flex items-center gap-1.5"><Clock className="w-4 h-4 text-[--color-brand-600]"/> {post.readTime}</span>
            </div>
      ...
      <section className="section bg-slate-50">
        <div className="container-page">
          <h2 className="font-display font-extrabold text-3xl text-[--color-brand-900]">Read next</h2>
